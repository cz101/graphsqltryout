...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;transform:skew(-7deg);a{padding:0.5rem 1rem;background:red;color:white;text-transform:uppercase;text-decoration:none;}@media (max-width:1300px){margin:0;text-align:center;}"]);
var HeaderStyles = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.header.withConfig({
...
function Header() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(HeaderStyles, {
    ...
    __self: this
  }, "Search")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Nav__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 57
    },
...
function Page(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: this
  }, " im in page comonent"), children);
}
Page.prototypes = {
  children: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.any // children: PropTypes.arrayOf(PropTypes.node)
...
next_router__WEBPACK_IMPORTED_MODULE_2___default.a.events.on('routeChangeError', function () {
  return nprogress__WEBPACK_IMPORTED_MODULE_3___default.a.error();
});
function MyApp(_ref) {
