...
var EndpointDialog = /** @class */ (function () {
    ...
    EndpointDialog.prototype.handleChoice = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var clusterEndpoint, cluster, workspace, service, stage, credentials, dockerComposeYml, datamodel, newDatabase, managementSecret, writeDockerComposeYml, _c, needsAuth, type, _d, defaultHosts, before, before, client, connector, introspector, schemas, e_1, schema, _e, numTables, sdl, demoCluster, result_1, _f, _g, generator, _h;
                ...
                switch (_j.label) {
                    case 0:
                        ...
                        switch (_c) {
                            ...
                            case 'Demo server': return [3 /*break*/, 24];
                        }
                        return [3 /*break*/, 26];
                    ...
                    case 13:
                        credentials = _j.sent();
                        if (!(credentials.type === 'mongo')) return [3 /*break*/, 15];
                        before = Date.now();
                    ...
                    case 14:
                        ...
                        _j.label = 15;
                    case 15:
                        if (!(credentials.type !== 'mongo')) return [3 /*break*/, 23];
                        this.out.log('');
                        before = Date.now();
                    ...
                    case 19:
                        if (!(credentials &&
                            ...
                            schemas &&
                            schemas.length > 0)) return [3 /*break*/, 22];
                    ...
                    case 32:
                        ...
                        _j.label = 33;
                    case 33:
                        if (!_g) return [3 /*break*/, 35];
                        return [4 /*yield*/, this.askForStage('dev')];
                    case 34:
                        stage = _j.sent();
                        _j.label = 35;
                    case 35:
                        if (!this.shouldAskForGenerator) return [3 /*break*/, 37];
    ...
    EndpointDialog.prototype.getDatabase = function (introspection) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var type, credentials, alreadyData, _a, askForSchema, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, alreadyData, _o;
            return __generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 16:
                        ...
                        return [3 /*break*/, 21];
                    case 17:
                        if (!(type === 'mongo')) return [3 /*break*/, 21];
                        _m = credentials;
                        return [4 /*yield*/, this.ask({
                    ...
                    case 19:
                        alreadyData = _p.sent();
                        if (!alreadyData) return [3 /*break*/, 21];
                        _o = credentials;
                        return [4 /*yield*/, this.ask({
                    ...
                    case 20:
                        _o.database = _p.sent();
                        _p.label = 21;
                    case 21: return [2 /*return*/, credentials];
                }
            });
        });
    };
